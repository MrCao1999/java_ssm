...
<!--     内容主体区域 -->
	...
	<table border="1">
		...
		<c:forEach items="${page.pageData}" var="list" varStatus="i">
			...
			<td>
				<a href="/grade/update?id=${list.id }">修改</a>
	...
	<table>
		...
		<td><a href="/grade/page?pageNum=1">首页</a></td>
		<c:if test="${ page.currentPage>1}">
		<td><a href="/grade/page?pageNum=${page.currentPage-1 }">上一页</a></td>
		</c:if>
		<c:if test="${ page.currentPage<page.totalPage}">
		<td><a href="/grade/page?pageNum=${page.currentPage+1 }">下一页</a></td>
		</c:if>
		<td><a href="/grade/page?pageNum=${page.totalPage }">尾页</a></td>
		</tr>
	</table>
